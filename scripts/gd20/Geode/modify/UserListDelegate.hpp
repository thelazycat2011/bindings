...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UserListDelegate> : ModifyBase<ModifyDerive<Der, UserListDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UserListDelegate, getUserListFinished, cocos2d::CCArray*, UserListType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UserListDelegate, getUserListFailed, UserListType, GJErrorCode)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UserListDelegate, userListChanged, cocos2d::CCArray*, UserListType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UserListDelegate, forceReloadList, UserListType)
		}
	};
}
