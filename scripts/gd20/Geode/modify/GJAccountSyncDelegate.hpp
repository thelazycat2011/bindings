...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountSyncDelegate> : ModifyBase<ModifyDerive<Der, GJAccountSyncDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountSyncDelegate, syncAccountFailed, BackupAccountError)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountSyncDelegate, syncAccountFinished, )
		}
	};
}
