...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SlideInLayer> : ModifyBase<ModifyDerive<Der, SlideInLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SlideInLayer, getDelegate, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SlideInLayer, getRemoveOnExit, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SlideInLayer, setDelegate, SlideInLayerDelegate*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SlideInLayer, setRemoveOnExit, bool)
