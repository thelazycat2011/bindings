...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ObjectDecoder> : ModifyBase<ModifyDerive<Der, ObjectDecoder>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&ObjectDecoder::sharedDecoder)), Cdecl, ObjectDecoder, sharedDecoder, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&ObjectDecoder::getDelegate)), Thiscall, ObjectDecoder, getDelegate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<ObjectDecoderDelegate*>::func(&ObjectDecoder::setDelegate)), Thiscall, ObjectDecoder, setDelegate, ObjectDecoderDelegate*)
		}
	};
}
