...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FriendRequestDelegate> : ModifyBase<ModifyDerive<Der, FriendRequestDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestDelegate, loadFRequestsFinished, cocos2d::CCArray*, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestDelegate, loadFRequestsFailed, char const*, GJErrorCode)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestDelegate, setupPageInfo, gd::string, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestDelegate, forceReloadRequests, bool)
		}
	};
}
