...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, OBB2D> : ModifyBase<ModifyDerive<Der, OBB2D>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, create, cocos2d::CCPoint, float, float, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, calculateWithCenter, cocos2d::CCPoint, float, float, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, computeAxes, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, getBoundingRect, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, init, cocos2d::CCPoint, float, float, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, orderCorners, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, overlaps, OBB2D*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(OBB2D, overlaps1Way, OBB2D*)
		}
	};
}
