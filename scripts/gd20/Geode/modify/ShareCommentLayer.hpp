...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareCommentLayer> : ModifyBase<ModifyDerive<Der, ShareCommentLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, create, gd::string, int, CommentType, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, init, gd::string, int, CommentType, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, onClose, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, onShare, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, updateCharCountLabel, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, updateDescText, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, registerWithTouchDispatcher, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, keyBackClicked, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, textInputOpened, CCTextInputNode*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, textInputClosed, CCTextInputNode*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, textChanged, CCTextInputNode*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, uploadActionFinished, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, uploadActionFailed, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareCommentLayer, onClosePopup, UploadActionPopup*)
		}
	};
}
