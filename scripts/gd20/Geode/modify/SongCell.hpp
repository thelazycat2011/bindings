...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongCell> : ModifyBase<ModifyDerive<Der, SongCell>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SongCell, loadFromObject, SongObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SongCell, onClick, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SongCell, updateBGColor, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SongCell, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SongCell, draw, )
		}
	};
}
