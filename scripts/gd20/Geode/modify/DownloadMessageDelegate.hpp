...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DownloadMessageDelegate> : ModifyBase<ModifyDerive<Der, DownloadMessageDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(DownloadMessageDelegate, downloadMessageFinished, GJUserMessage*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(DownloadMessageDelegate, downloadMessageFailed, int)
		}
	};
}
