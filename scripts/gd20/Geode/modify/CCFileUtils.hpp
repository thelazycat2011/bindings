...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_getClassTypeInfo
		#define GEODE_STATICS_getClassTypeInfo
		GEODE_AS_STATIC_FUNCTION(getClassTypeInfo) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_getClassTypeInfo
		#define GEODE_CONCEPT_CHECK_getClassTypeInfo
		GEODE_CONCEPT_FUNCTION_CHECK(getClassTypeInfo) 
	#endif
	...
	struct ModifyDerive<Der, cocos2d::CCFileUtils> : ModifyBase<ModifyDerive<Der, cocos2d::CCFileUtils>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCFileUtils@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCFileUtils)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::getClassTypeInfo)), Thiscall, cocos2d::CCFileUtils, getClassTypeInfo, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, const char*, unsigned long*>::func(&cocos2d::CCFileUtils::getFileData)), Thiscall, cocos2d::CCFileUtils, getFileData, const char*, const char*, unsigned long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, const char*, unsigned long*>::func(&cocos2d::CCFileUtils::getFileDataFromZip)), Thiscall, cocos2d::CCFileUtils, getFileDataFromZip, const char*, const char*, unsigned long*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, bool>::func(&cocos2d::CCFileUtils::fullPathForFilename)), Thiscall, cocos2d::CCFileUtils, fullPathForFilename, const char*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCFileUtils::removeFullPath)), Thiscall, cocos2d::CCFileUtils, removeFullPath, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCFileUtils::loadFilenameLookupDictionaryFromFile)), Thiscall, cocos2d::CCFileUtils, loadFilenameLookupDictionaryFromFile, const char*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*, const char*>::func(&cocos2d::CCFileUtils::fullPathFromRelativeFile)), Thiscall, cocos2d::CCFileUtils, fullPathFromRelativeFile, const char*, const char*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCFileUtils::addSearchResolutionsOrder)), Thiscall, cocos2d::CCFileUtils, addSearchResolutionsOrder, const char*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const gd::vector<gd::string>&>::func(&cocos2d::CCFileUtils::setSearchPaths)), Thiscall, cocos2d::CCFileUtils, setSearchPaths, const gd::vector<gd::string>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCFileUtils::addSearchPath)), Thiscall, cocos2d::CCFileUtils, addSearchPath, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char *>::func(&cocos2d::CCFileUtils::removeSearchPath)), Thiscall, cocos2d::CCFileUtils, removeSearchPath, const char *)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const gd::string&>::func(&cocos2d::CCFileUtils::isAbsolutePath)), Thiscall, cocos2d::CCFileUtils, isAbsolutePath, const gd::string&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCFileUtils::getNewFilename)), Thiscall, cocos2d::CCFileUtils, getNewFilename, const char*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const gd::string&, const gd::string&, const gd::string&>::func(&cocos2d::CCFileUtils::getPathForFilename)), Thiscall, cocos2d::CCFileUtils, getPathForFilename, const gd::string&, const gd::string&, const gd::string&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const gd::string&, const gd::string&>::func(&cocos2d::CCFileUtils::getFullPathForDirectoryAndFilename)), Thiscall, cocos2d::CCFileUtils, getFullPathForDirectoryAndFilename, const gd::string&, const gd::string&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const gd::string&>::func(&cocos2d::CCFileUtils::createCCDictionaryWithContentsOfFile)), Thiscall, cocos2d::CCFileUtils, createCCDictionaryWithContentsOfFile, const gd::string&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCDictionary*, const gd::string&>::func(&cocos2d::CCFileUtils::writeToFile)), Thiscall, cocos2d::CCFileUtils, writeToFile, cocos2d::CCDictionary*, const gd::string&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const gd::string&>::func(&cocos2d::CCFileUtils::createCCArrayWithContentsOfFile)), Thiscall, cocos2d::CCFileUtils, createCCArrayWithContentsOfFile, const gd::string&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCFileUtils::getAndroidPath)), Thiscall, cocos2d::CCFileUtils, getAndroidPath, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<gd::string>::func(&cocos2d::CCFileUtils::setAndroidPath)), Thiscall, cocos2d::CCFileUtils, setAndroidPath, gd::string)
		}
	};
}
