...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelUploadDelegate> : ModifyBase<ModifyDerive<Der, LevelUploadDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LevelUploadDelegate, levelUploadFinished, GJGameLevel*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LevelUploadDelegate, levelUploadFailed, GJGameLevel*)
		}
	};
}
