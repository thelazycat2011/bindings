...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UpdateAccountSettingsPopup> : ModifyBase<ModifyDerive<Der, UpdateAccountSettingsPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UpdateAccountSettingsPopup, create, GJAccountSettingsLayer*, int, int, gd::string)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UpdateAccountSettingsPopup, init, GJAccountSettingsLayer*, int, int, gd::string)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UpdateAccountSettingsPopup, onClose, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UpdateAccountSettingsPopup, keyBackClicked, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UpdateAccountSettingsPopup, updateSettingsFinished, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UpdateAccountSettingsPopup, updateSettingsFailed, )
		}
	};
}
