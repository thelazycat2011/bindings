...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMessagePopup> : ModifyBase<ModifyDerive<Der, GJMessagePopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, create, GJUserMessage*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, blockUser, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, init, GJUserMessage*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, loadFromGJMessage, GJUserMessage*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, onBlock, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, onClose, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, onRemove, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, onReply, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, keyBackClicked, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, downloadMessageFinished, GJUserMessage*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, downloadMessageFailed, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, uploadActionFinished, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, uploadActionFailed, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, onClosePopup, UploadActionPopup*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMessagePopup, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
