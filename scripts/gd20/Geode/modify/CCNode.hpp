...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_isScheduled
		#define GEODE_STATICS_isScheduled
		GEODE_AS_STATIC_FUNCTION(isScheduled) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_isScheduled
		#define GEODE_CONCEPT_CHECK_isScheduled
		GEODE_CONCEPT_FUNCTION_CHECK(isScheduled) 
	#endif
	...
	struct ModifyDerive<Der, cocos2d::CCNode> : ModifyBase<ModifyDerive<Der, cocos2d::CCNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCNode@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCNode, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCNode@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCNode)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::CCPoint&>::func(&cocos2d::CCNode::convertToNodeSpace)), Thiscall, cocos2d::CCNode, convertToNodeSpace, const cocos2d::CCPoint&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::CCPoint&>::func(&cocos2d::CCNode::convertToWorldSpace)), Thiscall, cocos2d::CCNode, convertToWorldSpace, const cocos2d::CCPoint&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::CCPoint&>::func(&cocos2d::CCNode::convertToNodeSpaceAR)), Thiscall, cocos2d::CCNode, convertToNodeSpaceAR, const cocos2d::CCPoint&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::CCPoint&>::func(&cocos2d::CCNode::convertToWorldSpaceAR)), Thiscall, cocos2d::CCNode, convertToWorldSpaceAR, const cocos2d::CCPoint&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::CCAffineTransform&>::func(&cocos2d::CCNode::setAdditionalTransform)), Thiscall, cocos2d::CCNode, setAdditionalTransform, const cocos2d::CCAffineTransform&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char *>::func(&cocos2d::CCNode::getComponent)), Thiscall, cocos2d::CCNode, getComponent, const char *)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::SEL_SCHEDULE>::func(&cocos2d::CCNode::isScheduled)), Thiscall, cocos2d::CCNode, isScheduled, cocos2d::SEL_SCHEDULE)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::CCPoint&>::func(&cocos2d::CCNode::setPosition)), Thiscall, cocos2d::CCNode, setPosition, const cocos2d::CCPoint&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::CCPoint&>::func(&cocos2d::CCNode::setAnchorPoint)), Thiscall, cocos2d::CCNode, setAnchorPoint, const cocos2d::CCPoint&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::CCSize&>::func(&cocos2d::CCNode::setContentSize)), Thiscall, cocos2d::CCNode, setContentSize, const cocos2d::CCSize&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCNode::getTag)), Thiscall, cocos2d::CCNode, getTag, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<int>::func(&cocos2d::CCNode::setTag)), Thiscall, cocos2d::CCNode, setTag, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const char*>::func(&cocos2d::CCNode::removeComponent)), Thiscall, cocos2d::CCNode, removeComponent, const char*)
