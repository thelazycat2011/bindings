...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionInstant> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionInstant>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCActionInstant@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCActionInstant, )
