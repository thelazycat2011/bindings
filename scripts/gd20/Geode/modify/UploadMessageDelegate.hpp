...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadMessageDelegate> : ModifyBase<ModifyDerive<Der, UploadMessageDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UploadMessageDelegate, uploadMessageFinished, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UploadMessageDelegate, uploadMessageFailed, int)
		}
	};
}
