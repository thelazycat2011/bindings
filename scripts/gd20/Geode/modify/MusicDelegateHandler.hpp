...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MusicDelegateHandler> : ModifyBase<ModifyDerive<Der, MusicDelegateHandler>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MusicDelegateHandler, create, MusicDownloadDelegate*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MusicDelegateHandler, getDelegate, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MusicDelegateHandler, init, MusicDownloadDelegate*)
		}
	};
}
