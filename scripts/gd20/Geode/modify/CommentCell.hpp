...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommentCell> : ModifyBase<ModifyDerive<Der, CommentCell>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, loadFromComment, GJComment*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, onConfirmDelete, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, onDelete, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, onLike, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, onUndelete, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, onUnhide, cocos2d::CCObject*)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, draw, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, likedItem, LikeItemType, int, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CommentCell, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
