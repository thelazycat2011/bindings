...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EndPortalObject> : ModifyBase<ModifyDerive<Der, EndPortalObject>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(EndPortalObject, calculateSpawnXPos, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(EndPortalObject, triggerObject, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(EndPortalObject, updateColors, cocos2d::ccColor3B)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(EndPortalObject, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(EndPortalObject, setPosition, cocos2d::CCPoint const&)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(EndPortalObject, setVisible, bool)
		}
	};
}
