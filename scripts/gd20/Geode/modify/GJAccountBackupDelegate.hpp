...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountBackupDelegate> : ModifyBase<ModifyDerive<Der, GJAccountBackupDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountBackupDelegate, backupAccountFailed, BackupAccountError)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountBackupDelegate, backupAccountFinished, )
		}
	};
}
