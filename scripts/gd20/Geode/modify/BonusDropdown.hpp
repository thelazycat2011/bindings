...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BonusDropdown> : ModifyBase<ModifyDerive<Der, BonusDropdown>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BonusDropdown, getTargetScene, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BonusDropdown, init, gd::string, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BonusDropdown, setTargetScene, cocos2d::CCNode*)
