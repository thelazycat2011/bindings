...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCAnimateFrameCache> : ModifyBase<ModifyDerive<Der, CCAnimateFrameCache>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCAnimateFrameCache, sharedSpriteFrameCache, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCAnimateFrameCache, addDict, DS_Dictionary*, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCAnimateFrameCache, addSpriteFramesWithFile, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCAnimateFrameCache, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCAnimateFrameCache, purgeSharedSpriteFrameCache, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCAnimateFrameCache, removeSpriteFrames, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCAnimateFrameCache, spriteFrameByName, char const*)
		}
	};
}
