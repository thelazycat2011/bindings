...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UserInfoDelegate> : ModifyBase<ModifyDerive<Der, UserInfoDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UserInfoDelegate, getUserInfoFinished, GJUserScore*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UserInfoDelegate, getUserInfoFailed, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UserInfoDelegate, userInfoChanged, GJUserScore*)
		}
	};
}
