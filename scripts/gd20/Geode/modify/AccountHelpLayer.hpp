...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountHelpLayer> : ModifyBase<ModifyDerive<Der, AccountHelpLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, onAccountManagement, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, onReLogin, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, onUnlink, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, updatePage, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, verifyUnlink, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, customSetup, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, layerHidden, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, accountStatusChanged, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountHelpLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
