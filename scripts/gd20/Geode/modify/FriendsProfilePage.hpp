...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FriendsProfilePage> : ModifyBase<ModifyDerive<Der, FriendsProfilePage>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, create, UserListType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, init, UserListType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, onBlocked, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, onClose, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, onUpdate, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, setupUsersBrowser, cocos2d::CCArray*, UserListType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, registerWithTouchDispatcher, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, keyBackClicked, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, getUserListFinished, cocos2d::CCArray*, UserListType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, getUserListFailed, UserListType, GJErrorCode)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, userListChanged, cocos2d::CCArray*, UserListType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendsProfilePage, forceReloadList, UserListType)
		}
	};
}
