...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlatformToolbox> : ModifyBase<ModifyDerive<Der, PlatformToolbox>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlatformToolbox, getDisplaySize, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlatformToolbox, hideCursor, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlatformToolbox, isControllerConnected, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlatformToolbox, loadAndDecryptFileToString, char const*, char const*)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlatformToolbox, showCursor, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlatformToolbox, toggleFullScreen, bool)
