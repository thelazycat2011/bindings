...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerRGBA> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerRGBA>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCLayerRGBA@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCLayerRGBA, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCLayerRGBA@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCLayerRGBA)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GLubyte>::func(&cocos2d::CCLayerRGBA::setOpacity)), Thiscall, cocos2d::CCLayerRGBA, setOpacity, GLubyte)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GLubyte>::func(&cocos2d::CCLayerRGBA::updateDisplayedOpacity)), Thiscall, cocos2d::CCLayerRGBA, updateDisplayedOpacity, GLubyte)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor3B&>::func(&cocos2d::CCLayerRGBA::setColor)), Thiscall, cocos2d::CCLayerRGBA, setColor, const cocos2d::ccColor3B&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor3B&>::func(&cocos2d::CCLayerRGBA::updateDisplayedColor)), Thiscall, cocos2d::CCLayerRGBA, updateDisplayedColor, const cocos2d::ccColor3B&)
