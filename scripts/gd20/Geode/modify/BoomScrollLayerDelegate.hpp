...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BoomScrollLayerDelegate> : ModifyBase<ModifyDerive<Der, BoomScrollLayerDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BoomScrollLayerDelegate, scrollLayerScrollingStarted, BoomScrollLayer*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BoomScrollLayerDelegate, scrollLayerScrolledToPage, BoomScrollLayer*, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BoomScrollLayerDelegate, scrollLayerMoved, cocos2d::CCPoint)
		}
	};
}
