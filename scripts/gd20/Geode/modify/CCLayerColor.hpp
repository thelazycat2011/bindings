...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLayerColor> : ModifyBase<ModifyDerive<Der, cocos2d::CCLayerColor>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::ccColor4B&, float, float>::func(&cocos2d::CCLayerColor::create)), Cdecl, cocos2d::CCLayerColor, create, const cocos2d::ccColor4B&, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::ccColor4B&>::func(&cocos2d::CCLayerColor::create)), Cdecl, cocos2d::CCLayerColor, create, const cocos2d::ccColor4B&)
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCLayerColor@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCLayerColor, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCLayerColor@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCLayerColor)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::CCSize&>::func(&cocos2d::CCLayerColor::setContentSize)), Thiscall, cocos2d::CCLayerColor, setContentSize, const cocos2d::CCSize&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor4B&, float, float>::func(&cocos2d::CCLayerColor::initWithColor)), Thiscall, cocos2d::CCLayerColor, initWithColor, const cocos2d::ccColor4B&, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor4B&>::func(&cocos2d::CCLayerColor::initWithColor)), Thiscall, cocos2d::CCLayerColor, initWithColor, const cocos2d::ccColor4B&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<const cocos2d::ccColor3B&>::func(&cocos2d::CCLayerColor::setColor)), Thiscall, cocos2d::CCLayerColor, setColor, const cocos2d::ccColor3B&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<GLubyte>::func(&cocos2d::CCLayerColor::setOpacity)), Thiscall, cocos2d::CCLayerColor, setOpacity, GLubyte)
