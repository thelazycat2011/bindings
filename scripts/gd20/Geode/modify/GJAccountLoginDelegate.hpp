...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountLoginDelegate> : ModifyBase<ModifyDerive<Der, GJAccountLoginDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountLoginDelegate, loginAccountFinished, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountLoginDelegate, loginAccountFailed, AccountError)
		}
	};
}
