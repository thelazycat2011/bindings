...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ButtonPage> : ModifyBase<ModifyDerive<Der, ButtonPage>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ButtonPage, create, cocos2d::CCArray*, cocos2d::CCPoint, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ButtonPage, init, cocos2d::CCArray*, cocos2d::CCPoint, int, float)
		}
	};
}
