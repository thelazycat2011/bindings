...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, StatsCell> : ModifyBase<ModifyDerive<Der, StatsCell>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(StatsCell, loadFromObject, StatsObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(StatsCell, updateBGColor, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(StatsCell, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(StatsCell, draw, )
		}
	};
}
