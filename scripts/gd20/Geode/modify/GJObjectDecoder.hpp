...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJObjectDecoder> : ModifyBase<ModifyDerive<Der, GJObjectDecoder>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJObjectDecoder, sharedDecoder, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJObjectDecoder, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJObjectDecoder, getDecodedObject, int, DS_Dictionary*)
		}
	};
}
