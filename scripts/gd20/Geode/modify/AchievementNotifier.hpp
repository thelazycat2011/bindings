...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AchievementNotifier> : ModifyBase<ModifyDerive<Der, AchievementNotifier>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AchievementNotifier, sharedState, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AchievementNotifier, achievementDisplayFinished, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AchievementNotifier, notifyAchievement, char const*, char const*, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AchievementNotifier, showNextAchievement, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AchievementNotifier, willSwitchToScene, cocos2d::CCScene*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AchievementNotifier, init, )
		}
	};
}
