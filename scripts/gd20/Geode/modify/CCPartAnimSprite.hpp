...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_getSpriteContainer
		#define GEODE_STATICS_getSpriteContainer
		GEODE_AS_STATIC_FUNCTION(getSpriteContainer) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_getSpriteContainer
		#define GEODE_CONCEPT_CHECK_getSpriteContainer
		GEODE_CONCEPT_FUNCTION_CHECK(getSpriteContainer) 
	#endif
	...
	struct ModifyDerive<Der, CCPartAnimSprite> : ModifyBase<ModifyDerive<Der, CCPartAnimSprite>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, createWithAnimDesc, char const*, cocos2d::CCTexture2D*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, dirtify, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, getSpriteContainer, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, getSpriteForKey, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, initWithAnimDesc, char const*, cocos2d::CCTexture2D*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, setColor, cocos2d::ccColor3B)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, transformSprite, frameValues)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, tweenSpriteTo, frameValues, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, tweenToFrame, cocos2d::CCSpriteFrame*, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, setScaleX, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, setScaleY, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, setScale, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, setOpacity, unsigned char)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, setBlendFunc, cocos2d::_ccBlendFunc)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, setDisplayFrame, cocos2d::CCSpriteFrame*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, isFrameDisplayed, cocos2d::CCSpriteFrame*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, displayFrame, )
		}
	};
}
