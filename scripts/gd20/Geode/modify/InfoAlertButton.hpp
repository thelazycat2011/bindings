...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, InfoAlertButton> : ModifyBase<ModifyDerive<Der, InfoAlertButton>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(InfoAlertButton, create, gd::string, gd::string, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(InfoAlertButton, init, gd::string, gd::string, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(InfoAlertButton, activate, )
		}
	};
}
