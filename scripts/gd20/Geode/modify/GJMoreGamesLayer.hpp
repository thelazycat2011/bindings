...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMoreGamesLayer> : ModifyBase<ModifyDerive<Der, GJMoreGamesLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMoreGamesLayer, create, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMoreGamesLayer, getMoreGamesList, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJMoreGamesLayer, customSetup, )
		}
	};
}
