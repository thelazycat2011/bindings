...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_getEnableBannerOnClose
		#define GEODE_STATICS_getEnableBannerOnClose
		GEODE_AS_STATIC_FUNCTION(getEnableBannerOnClose) 
	#endif
	...
	#ifndef GEODE_STATICS_setEnableBannerOnClose
		#define GEODE_STATICS_setEnableBannerOnClose
		GEODE_AS_STATIC_FUNCTION(setEnableBannerOnClose) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_getEnableBannerOnClose
		#define GEODE_CONCEPT_CHECK_getEnableBannerOnClose
		GEODE_CONCEPT_FUNCTION_CHECK(getEnableBannerOnClose) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_setEnableBannerOnClose
		#define GEODE_CONCEPT_CHECK_setEnableBannerOnClose
		GEODE_CONCEPT_FUNCTION_CHECK(setEnableBannerOnClose) 
	#endif
	...
	struct ModifyDerive<Der, PromoInterstitial> : ModifyBase<ModifyDerive<Der, PromoInterstitial>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PromoInterstitial, create, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PromoInterstitial, getEnableBannerOnClose, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PromoInterstitial, setEnableBannerOnClose, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PromoInterstitial, setup, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PromoInterstitial, init, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PromoInterstitial, registerWithTouchDispatcher, )
