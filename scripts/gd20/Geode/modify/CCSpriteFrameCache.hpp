...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSpriteFrameCache> : ModifyBase<ModifyDerive<Der, cocos2d::CCSpriteFrameCache>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFramesWithFile)), Thiscall, cocos2d::CCSpriteFrameCache, addSpriteFramesWithFile, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*, const char*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFramesWithFile)), Thiscall, cocos2d::CCSpriteFrameCache, addSpriteFramesWithFile, const char*, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*, cocos2d::CCTexture2D*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFramesWithFile)), Thiscall, cocos2d::CCSpriteFrameCache, addSpriteFramesWithFile, const char*, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCSpriteFrame*, const char*>::func(&cocos2d::CCSpriteFrameCache::addSpriteFrame)), Thiscall, cocos2d::CCSpriteFrameCache, addSpriteFrame, cocos2d::CCSpriteFrame*, const char*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCSpriteFrameCache::removeSpriteFrameByName)), Thiscall, cocos2d::CCSpriteFrameCache, removeSpriteFrameByName, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCSpriteFrameCache::removeSpriteFramesFromFile)), Thiscall, cocos2d::CCSpriteFrameCache, removeSpriteFramesFromFile, const char*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char *>::func(&cocos2d::CCSpriteFrameCache::spriteFrameByName)), Thiscall, cocos2d::CCSpriteFrameCache, spriteFrameByName, const char *)
		}
	};
}
