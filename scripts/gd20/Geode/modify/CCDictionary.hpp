...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCDictionary> : ModifyBase<ModifyDerive<Der, cocos2d::CCDictionary>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCDictionary@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCDictionary, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCDictionary@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCDictionary)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCDictionary::createWithContentsOfFile)), Cdecl, cocos2d::CCDictionary, createWithContentsOfFile, const char*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCDictionary::createWithContentsOfFileThreadSafe)), Cdecl, cocos2d::CCDictionary, createWithContentsOfFileThreadSafe, const char*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const gd::string&>::func(&cocos2d::CCDictionary::objectForKey)), Thiscall, cocos2d::CCDictionary, objectForKey, const gd::string&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const gd::string&>::func(&cocos2d::CCDictionary::valueForKey)), Thiscall, cocos2d::CCDictionary, valueForKey, const gd::string&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, const gd::string&>::func(&cocos2d::CCDictionary::setObject)), Thiscall, cocos2d::CCDictionary, setObject, cocos2d::CCObject*, const gd::string&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const gd::string&>::func(&cocos2d::CCDictionary::removeObjectForKey)), Thiscall, cocos2d::CCDictionary, removeObjectForKey, const gd::string&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const char*>::func(&cocos2d::CCDictionary::writeToFile)), Thiscall, cocos2d::CCDictionary, writeToFile, const char*)
