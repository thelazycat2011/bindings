...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FriendRequestPopup> : ModifyBase<ModifyDerive<Der, FriendRequestPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, create, GJFriendRequest*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, blockUser, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, init, GJFriendRequest*)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, onClose, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, onRemove, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, keyBackClicked, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, uploadActionFinished, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, uploadActionFailed, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, onClosePopup, UploadActionPopup*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
