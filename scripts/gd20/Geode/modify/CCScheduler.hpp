...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCScheduler> : ModifyBase<ModifyDerive<Der, cocos2d::CCScheduler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCScheduler@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCScheduler)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<const cocos2d::CCObject*>::func(&cocos2d::CCScheduler::unscheduleUpdateForTarget)), Thiscall, cocos2d::CCScheduler, unscheduleUpdateForTarget, const cocos2d::CCObject*)
