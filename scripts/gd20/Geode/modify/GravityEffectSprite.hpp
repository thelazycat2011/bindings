...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GravityEffectSprite> : ModifyBase<ModifyDerive<Der, GravityEffectSprite>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GravityEffectSprite, create, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GravityEffectSprite, updateSpritesColor, cocos2d::ccColor3B)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GravityEffectSprite, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GravityEffectSprite, draw, )
		}
	};
}
