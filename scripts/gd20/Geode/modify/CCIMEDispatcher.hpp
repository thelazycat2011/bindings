...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCIMEDispatcher> : ModifyBase<ModifyDerive<Der, cocos2d::CCIMEDispatcher>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, int>::func(&cocos2d::CCIMEDispatcher::dispatchInsertText)), Thiscall, cocos2d::CCIMEDispatcher, dispatchInsertText, char const*, int)
