...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameObjectCopy> : ModifyBase<ModifyDerive<Der, GameObjectCopy>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameObjectCopy, create, GameObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameObjectCopy, getObject, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameObjectCopy, init, GameObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameObjectCopy, resetObject, )
		}
	};
}
