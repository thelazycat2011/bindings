...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareLevelSettingsLayer> : ModifyBase<ModifyDerive<Der, ShareLevelSettingsLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, create, GJGameLevel*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, init, GJGameLevel*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, onClose, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, onCopyable, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, onEditPassword, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, onPassword, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, updateSettingsState, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, numberInputClosed, NumberInputLayer*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShareLevelSettingsLayer, keyBackClicked, )
		}
	};
}
