...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_frameToKey
		#define GEODE_STATICS_frameToKey
		GEODE_AS_STATIC_FUNCTION(frameToKey) 
	#endif
	...
	#ifndef GEODE_STATICS_keyToFrame
		#define GEODE_STATICS_keyToFrame
		GEODE_AS_STATIC_FUNCTION(keyToFrame) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_frameToKey
		#define GEODE_CONCEPT_CHECK_frameToKey
		GEODE_CONCEPT_FUNCTION_CHECK(frameToKey) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_keyToFrame
		#define GEODE_CONCEPT_CHECK_keyToFrame
		GEODE_CONCEPT_FUNCTION_CHECK(keyToFrame) 
	#endif
	...
	struct ModifyDerive<Der, ObjectToolbox> : ModifyBase<ModifyDerive<Der, ObjectToolbox>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, sharedState, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, allKeys, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, frameToKey, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, gridNodeSizeForKey, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, intKeyToFrame, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, keyToFrame, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, perspectiveBlockFrame, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectToolbox, init, )
		}
	};
}
