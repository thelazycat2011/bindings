...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountLayer> : ModifyBase<ModifyDerive<Der, AccountLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, create, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, backupAccountFailed, BackupAccountError)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, doBackup, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, doSync, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, exitLayer, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, hideLoadingUI, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, onRegister, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, onSync, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, showLoadingUI, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, syncAccountFailed, BackupAccountError)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, toggleUI, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, updatePage, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, customSetup, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, layerHidden, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, backupAccountFinished, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, syncAccountFinished, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, accountStatusChanged, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(AccountLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
