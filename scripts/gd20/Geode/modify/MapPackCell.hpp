...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MapPackCell> : ModifyBase<ModifyDerive<Der, MapPackCell>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, loadFromMapPack, GJMapPack*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, onClaimReward, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, onClick, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, playCompleteEffect, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, reloadCell, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, updateBGColor, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MapPackCell, draw, )
		}
	};
}
