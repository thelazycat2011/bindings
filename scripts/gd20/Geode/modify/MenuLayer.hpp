...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_showPirateMessage
		#define GEODE_STATICS_showPirateMessage
		GEODE_AS_STATIC_FUNCTION(showPirateMessage) 
	#endif
	...
	#ifndef GEODE_CONCEPT_CHECK_showPirateMessage
		#define GEODE_CONCEPT_CHECK_showPirateMessage
		GEODE_CONCEPT_FUNCTION_CHECK(showPirateMessage) 
	#endif
	...
	struct ModifyDerive<Der, MenuLayer> : ModifyBase<ModifyDerive<Der, MenuLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, endGame, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, node, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onAchievements, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onCreator, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onEveryplay, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onFacebook, cocos2d::CCObject*)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onGarage, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onGooglePlayGames, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11e230, Membercall, MenuLayer, onMoreGames, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onMyProfile, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onNewgrounds, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onOptions, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onOptionsInstant, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onPlay, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onQuit, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onRobTop, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onStats, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onTrailer, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onTwitter, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, onYouTube, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, openOptions, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, scene, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, showGCQuestion, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, showPirateMessage, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, updateUserProfileButton, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, willClose, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11cf60, Thiscall, MenuLayer, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, keyBackClicked, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, keyDown, cocos2d::enumKeyCodes)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, googlePlaySignedIn, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}
