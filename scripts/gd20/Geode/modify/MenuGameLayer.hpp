...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MenuGameLayer> : ModifyBase<ModifyDerive<Der, MenuGameLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, create, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, destroyPlayer, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, getBGColor, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, resetPlayer, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, tryJump, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, updateColor, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, updateColors, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, update, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MenuGameLayer, registerWithTouchDispatcher, )
		}
	};
}
