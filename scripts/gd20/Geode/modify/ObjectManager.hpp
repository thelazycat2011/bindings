...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ObjectManager> : ModifyBase<ModifyDerive<Der, ObjectManager>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, getDefinition, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, getGlobalAnimCopy, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, instance, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, loadCopiedAnimations, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, setup, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, init, )
		}
	};
}
