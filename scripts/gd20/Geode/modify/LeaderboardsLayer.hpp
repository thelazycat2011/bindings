...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LeaderboardsLayer> : ModifyBase<ModifyDerive<Der, LeaderboardsLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, create, LeaderboardState)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, init, LeaderboardState)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, isCorrect, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, onBack, cocos2d::CCObject*)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, refreshTabs, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, scene, LeaderboardState)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, selectLeaderboard, LeaderboardState)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, setupLevelBrowser, cocos2d::CCArray*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, setupTabs, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, toggleTabButtons, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, keyBackClicked, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, updateUserScoreFinished, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, updateUserScoreFailed, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, loadLeaderboardFinished, cocos2d::CCArray*, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(LeaderboardsLayer, loadLeaderboardFailed, char const*)
		}
	};
}
