...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRotationControlDelegate> : ModifyBase<ModifyDerive<Der, GJRotationControlDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJRotationControlDelegate, angleChanged, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJRotationControlDelegate, angleChangeBegin, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJRotationControlDelegate, angleChangeEnded, )
		}
	};
}
