...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BitmapFontCache> : ModifyBase<ModifyDerive<Der, BitmapFontCache>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BitmapFontCache, sharedFontCache, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BitmapFontCache, fontWithConfigFile, char const*, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BitmapFontCache, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(BitmapFontCache, purgeSharedFontCache, )
		}
	};
}
