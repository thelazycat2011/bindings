...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadActionDelegate> : ModifyBase<ModifyDerive<Der, UploadActionDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UploadActionDelegate, uploadActionFinished, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(UploadActionDelegate, uploadActionFailed, int, int)
		}
	};
}
