...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ListCell> : ModifyBase<ModifyDerive<Der, ListCell>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ListCell, loadFromObject, cocos2d::CCObject*, int, int, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ListCell, updateBGColor, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ListCell, init, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ListCell, draw, )
		}
	};
}
