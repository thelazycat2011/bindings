...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountSettingsDelegate> : ModifyBase<ModifyDerive<Der, GJAccountSettingsDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountSettingsDelegate, updateSettingsFinished, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountSettingsDelegate, updateSettingsFailed, )
		}
	};
}
