...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SearchButton> : ModifyBase<ModifyDerive<Der, SearchButton>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SearchButton, create, char const*, char const*, float, char const*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SearchButton, getLabel, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SearchButton, getSprite, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SearchButton, init, char const*, char const*, float, char const*)
		}
	};
}
