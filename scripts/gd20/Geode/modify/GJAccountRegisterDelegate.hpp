...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountRegisterDelegate> : ModifyBase<ModifyDerive<Der, GJAccountRegisterDelegate>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountRegisterDelegate, registerAccountFinished, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJAccountRegisterDelegate, registerAccountFailed, AccountError)
		}
	};
}
