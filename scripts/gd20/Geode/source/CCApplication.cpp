...
cocos2d::CCApplication::~CCApplication() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCApplication@cocos2d@@UAE@XZ")), tulip::hook::TulipConvention::Thiscall);
