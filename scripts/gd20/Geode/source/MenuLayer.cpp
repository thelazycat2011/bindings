...
auto MenuLayer::onMoreGames(cocos2d::CCObject* sender) -> decltype(onMoreGames(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x11e230, tulip::hook::TulipConvention::Membercall);
...
auto MenuLayer::init() -> decltype(init()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x11cf60, tulip::hook::TulipConvention::Thiscall);
